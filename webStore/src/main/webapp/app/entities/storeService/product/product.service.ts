...
export class ProductService {
  public resourceUrl = SERVER_API_URL + 'services/storeservice/api/products';
  public resourceSearchUrl = SERVER_API_URL + 'services/storeservice/api/_search/products';
