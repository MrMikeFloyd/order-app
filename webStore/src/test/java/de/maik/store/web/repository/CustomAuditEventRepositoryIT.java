...
import de.maik.store.web.config.audit.AuditEventConverter;
import de.maik.store.web.domain.PersistentAuditEvent;
...
import static de.maik.store.web.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
