...
import de.maik.storeservice.service.PhotoService;
import de.maik.storeservice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link de.maik.storeservice.domain.Photo}.
 */
@RestController
@RequestMapping("/api")
