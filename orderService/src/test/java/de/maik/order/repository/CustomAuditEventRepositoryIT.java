...
import de.maik.order.config.audit.AuditEventConverter;
import de.maik.order.domain.PersistentAuditEvent;
...
import static de.maik.order.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
